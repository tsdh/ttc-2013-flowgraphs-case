...
\begin{figure}[h!]
  \centering
  \includegraphics[width=.9\linewidth]{../metamodel/StructureGraph}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.7\linewidth]{../metamodel/ControlFlowGraph}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\linewidth]{../metamodel/DataFlowGraph}
